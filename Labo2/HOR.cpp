...
uint8_t HOR::run()
{
    ...
    if(m_iX>0)
    {
        ...
        {
            m_stRect.xMin = 0;
            m_stRect.xMax = (128/(2.0*m_iX))*j;
            m_stRect.yMin = m_iZ - m_iX + j - 1;
            m_stRect.yMax = m_iZ - m_iX + j;
            ...
            m_stRect1.xMin = m_stRect.xMax ;
            m_stRect1.xMax = m_stRect.xMax + m_iHip;
            ...
            m_stRect.xMin = (128/(2.0*m_iX))*j;
            m_stRect.xMax = 128;
            m_stRect.yMin = m_iZ - m_iX + j - 3;
            m_stRect.yMax = m_iZ - m_iX + j - 2;
            m_uint16tulValue = 0X00FF; //blue
            Graphics_fillRectangleOnDisplay(&g_sCrystalfontz128x128, &m_stRect, m_uint16tulValue);
        }
    ...
    else if (m_iX<0)
    {
        ...
        {
            m_stRect.xMin = 0;
            m_stRect.xMax = 128-(128/(-2.0*m_iX))*j;
            m_stRect.yMin = m_iZ + m_iX + j - 1;
            m_stRect.yMax = m_iZ + m_iX + j ;
            m_uint16tulValue = 0X00FF; //blue
            Graphics_fillRectangleOnDisplay(&g_sCrystalfontz128x128, &m_stRect, m_uint16tulValue);
            ...
            m_stRect.xMin = 128-(128/(-2.0*m_iX))*j-m_iHip;
            m_stRect.xMax = 128;
            m_stRect.yMin = m_iZ + m_iX + j + 1;
            m_stRect.yMax = m_iZ + m_iX + j + 2;
            m_uint16tulValue = 0XAA00; //brown
    ...
    else
    {
        ...
        m_stRect1.xMin = 0;
        m_stRect1.xMax = 127;
        m_stRect1.yMin = m_iZ - m_iX  ;
        m_stRect1.yMax = m_iZ - m_iX + 1;
        m_uint16tulValue = 0XFFFF; //white
        Graphics_fillRectangleOnDisplay(&g_sCrystalfontz128x128, &m_stRect1, m_uint16tulValue);
